...
if ( $the_query->have_posts() ) : ?>
        ...
        <?php if($key == 0): ?>
            <div class="jumbotron jumbotron-fluid ghs_hero_banner mb-4" style="background-image: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ),
                ...
                <div class="container">
                    ...
                    <a class="btn btn-primary ghs_button" href="<?php echo get_the_permalink(get_the_ID()) ?>" role="button">Read More</a>
                </div>
            </div>
    ...
    <ul class="pagination pagination-lg justify-content-center">
		<?php global $wp_query; $current_page = $wp_query->query_vars['paged']; $pages = $the_query->max_num_pages; ?>
